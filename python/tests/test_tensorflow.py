...
def tf_loglik_runner(loglik_fun,discrete_time):    
    ...
    tte_actual,tte_censored,u_train = generate_data(
                                       A=real_a,
                                       B=real_a,
                                       C=real_a*2., # <np.inf -> impose censoring
    ...
    for step in range(2000):
        ...
        loss_val,_,a_val,b_val= sess.run([loss,train_step, a,b],feed_dict={y_: tte_censored,u_ : u_train})
